...
const ProductsListCard: FC<ProductProps> = ({
  id,
  img,
  name,
  price,
    ...
    <div>
      ...
      >
        ...
        <div className="product-card-content">
          <Link href={`product/${product.id}`}>
            <h3 className="heading heading-sub--4">{name}</h3>
            ...
            <div className="product-card-prices">
              <p className="label product-card-prices-new">${price}</p>
              {oldPrice && (
                <p className="label label--small product-card-prices-old">
                  ${oldPrice}
                </p>
              )}
            </div>
          ...
          <div className="product-card-icons">
            <span className="product-card-icon cart" onClick={handleAddToCart}>
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
            ...
            <span className="product-card-icon" onClick={handleToggleWishlist}>
