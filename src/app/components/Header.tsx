      ...
      <div className="header-top">
        <div className="header-content">
          <div className="header-top-left">
            <div className="header-top-left-element">
              <a
            ...
            <div className="header-top-left-element">
              <a href="tel:+1234567890" className="header-top-left-element">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
          ...
          <div className="header-top-right">
            <div
              className="language header-top-right-element"
              onClick={() => {
            ...
            >
              ...
              {isLanguageDropdownOpen ? (
                <div className="header-dropdown header-dropdown-language">
                  <div
                    className="header-dropdown-element"
            ...
            <div
              className="currency header-top-right-element"
              onClick={() => {
                setisCurrencyDropdownOpen(!isCurrencyDropdownOpen);
            ...
            >
              ...
              {isCurrencyDropdownOpen ? (
                <div className="header-dropdown header-dropdown-currency">
                  <div
                    className="header-dropdown-element"
            ...
            <div className="login-btn header-top-right-element">
              Login
              <svg
                width="16"
                height="16"
            ...
            <Link href="/wishlist">
              <div className="wishlist header-top-right-element">
                Wishlist
                <svg
                  width="16"
                  height="16"
                  ...
                  <Link key={product.id} href={`/product/${product.id}`}>
                    <div className="search-result-item">
                      ...
                      <div className="search-result-item-text">
                        <h4 className="heading heading-sub--4">
                          {product.name}
                        </h4>
                        <div className="search-prices">
                          <p className="label search-price search-prices-new">
                            ${product.price}
                          </p>
                          {product.oldPrice && (
                            <p className="label search-old-price search-prices-old">
                              ${product.oldPrice}
                            </p>
                          )}
                        </div>
