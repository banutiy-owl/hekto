...
const CategoryTabs: React.FC<CategoryTabsProps> = ({ categoryContent }) => {
  const [selectedCategory, setSelectedCategory] =
    useState<keyof CategoryTabsProps["categoryContent"]>("new");

  const handleCategoryClick = (
    category: keyof CategoryTabsProps["categoryContent"]
  ) => {
  ...
  const isProductInWishlist = (product: Product) => {
    return wishlist.some((card) => card.id === product.id);
  };
    ...
    <div className="category-tabs-container">
      ...
      <div className="category-content">
        <div className="latest-card-grid">
          {categoryContent[selectedCategory].map((card) => (
            <div key={card.id} className="latest-card-grid-content">
              <div className="latest-card-grid-overlay">
